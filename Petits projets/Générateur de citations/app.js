let citations = [
    ...
    ["You're so fucking bad man stop being garbage. Delete this game fucking bastard.","Guillaume Tasquin"],
    ["Je sais.","Guénolé Cherubin"],
    ["Wesh FRERE. Tranquille FRERE, c'est bon FRERE","Jeremy Taverne"],
    ["Ton daron boit du fioul","Tom Georges"],
    ["Get cancer you motherfucker I hope you die !!","Nicolas Tran"],
    ['C\'est surement dégueulasse ce que t\'as fait à manger','Un mec relou']
  ];
...
let quote = document.getElementById('citation'); 
  ...
  btn.addEventListener('click', genererCitation);
  ...
  {     genererNombreEntier(citations.length)
        quote.innerHTML = citations[nombreAleatoire][0];
